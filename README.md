...
The most important requirement for FLIP from the client was **autonomus driving** and e**xploring environments**. The team implemented these things to bring the Digital Twin to the next level:
...
Please read the [repository structure](#repository-structure) chapter below to learn how to navigate, read and use this repository accordingly.
