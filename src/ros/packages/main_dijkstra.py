    ...
    def dijkstra(self, occupancy_grid, starting_position, map_origin, map_resolution):
        ...
        while not frontier.empty():
            ...
            for neighbour in neighbouring_cells:
                ...
                rotation = abs(self.calc_relative_angle(world_x, world_y))

                new_cost = costs[current] + (0.8 * distance + 0.2 * rotation)

                if neighbour not in reached or new_cost < costs[neighbour]: 
                    ...
                    # Avoid any obstacles using self.costmap
                        ...
                        frontier.put((new_cost, neighbour)) # Priority, value
