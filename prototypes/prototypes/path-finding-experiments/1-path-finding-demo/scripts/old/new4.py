...
prev_pcd = None
icp_transform = np.eye(4)  # global transform
...
def lidar_cb(msg: LaserScan):
    ...
    for i, d in enumerate(msg.ranges):
        ...
        scan_points.append([wx, wy, 0.0])  # 2D → 3D
    ...
    pcd.points = o3d.utility.Vector3dVector(np.array(scan_points))
    ...
    if prev_pcd is not None:
        ...
        icp_transform = icp_transform @ reg.transformation

        pcd.transform(icp_transform)
