...
If you want to run the .ps1 file with a container using GPU instead if CPU, [see here](../../usingCuda/ReadME.md). There are some examples in this folder saved as `.txt` file, because `.ps1` files are in the `.gitignore`.